...
abstract class View {
  ...
  constructor(containerId: string, template: string) {
    ...
    if(!containerElement) {
      throw '최상위 컨테이너가 없어서 UI를 진행할 수 없습니다.'
    }
...
class NewsFeedView extends View {
  ...
  render(): void {
    ...
    this.setTemplateData('next_page', String(store.currentPage < this.feeds.length / 10 ? store.currentPage + 1 : store.currentPage));
...
class NewsDetailView extends View {
      ...
      <div class="bg-gray-600 min-h-screen pb-8">
        <div class="bg-white text-xl">
          <div class="mx-auto px-4">
            <div class="flex justify-between items-center py-6">
              <div class="flex justify-start">
                <h1 class="font-extraold">Hackr News</h1>
              </div>
              <div class="items-center justify-end">
  ...
  private makeComment(comments: NewsComment[]): string { 
    for(let i = 0; i < comments.length; i++) {
      ...
      this.addHtml(`
        <div style="padding-left: ${comment.level * 15}px;" class="mt-4">
